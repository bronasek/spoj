...
public class Obzartuchy {                           // id 626

    public static void main(String[] args) {        // GLUTTON 
        ...
        try {
            ...
            while (nt-- > 0) {
                ...
                int lo = Integer.parseInt(c[0]);
                int lcwp = Integer.parseInt(c[1]);
                int tc = 86400;
                double lc = 0;
                ...
                pw.println((int)Math.ceil(lc / lcwp));
